...
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567890", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567891", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 30
...
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567892", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567893", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 30
...
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567894", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567895", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 30
...
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567896", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 5
curl -w "\n" -X POST --data '{ "schema": "com.nordstrom/product/create/1-0-0", "id": "1234567897", "origin": "hello-retail/test-script-create-product/testid/mark", "category": "Things", "name": "A sort of thing", "brand": "ACME", "description": "A sort of thing from a company that makes everything", "price": "10", "user" : "Owen", "pass" : "owenspassword" }' $1
sleep 30
...
sleep 30
curl -w "\n" -X POST --data '{"user": "Owen", "pass": "owenspassword", "id": "1234567890"}' $4
sleep 5
curl -w "\n" -X POST --data '{"user": "Owen", "pass": "owenspassword", "id": "1234567891"}' $4
sleep 5
curl -w "\n" -X POST --data '{"user": "Owen", "pass": "owenspassword", "id": "1234567892"}' $4
sleep 5
curl -w "\n" -X POST --data '{"user": "Owen", "pass": "owenspassword", "id": "1234567893"}' $4
sleep 30
